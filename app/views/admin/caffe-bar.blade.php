    ...
    <h2 class="section-header">Administracija <i class="fa fa-angle-right"></i> Caffe Bar</h2>
    	...
    	<section class="section form-section">
		    ...
		    <div class="form-group">
		        ...
		        {{ Form::text('page_title', $caffe_bar_data->page_title, ['class' => 'form-input-control', 'placeholder' => 'Naslov stranice', 'id' => 'page_title', 'required']) }}
		    </div>
		    <div class="form-group">
		        {{ Form::label('page_text', 'Tekst stranice:') }}
		        {{ Form::textarea('page_text', $caffe_bar_data->page_text, ['class' => 'form-input-control', 'placeholder' => 'Tekst stranice', 'id' => 'codeEditor']) }}
		    </div>
		    <div class="form-group">
		        {{ Form::label('caffe_bar_images', 'Dodaj nove slike:') }}
		        {{ Form::file('caffe_bar_images[]', ['multiple' => true, 'class' => 'file', 'data-show-upload' => false, 'data-show-caption' => true, 'id' => 'caffe_bar_images', 'accept' => 'image/*']) }}
		   </div>
